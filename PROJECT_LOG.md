...
The held-out AFHQ Cats quick-200 protocol (seeds 1000-1199, Heun-50, CFG 1.0) gave: baseline raw 20k FID `48.051`, KID `0.02052`, precision `0.340`, recall `0.754`; always-on REPA raw 20k `52.384`, `0.02531`, `0.310`, `0.722`; early-stop raw 20k `45.787`, `0.01692`, `0.280`, `0.732`. Early-stop improved FID/KID over both alternatives, but lost precision `0.060` and recall `0.022` against baseline. The evaluator in fact completed twice under the same fixed protocol: canonical event `afhq-cats-baseline-vs-repa-quick-10k-20k-20260718-3` (69.637512 s) and a redundant verification event `afhq-cats-baseline-vs-repa-quick-10k-20k-20260718-4` (69.857339 s). Their stored metrics and changes are identical; this repeat is not an independent statistical replicate. Both runs reported all three checkpoint hashes unchanged, zero pixel finite/black-white failures, low-detail warnings, and feature duplicate pairs; fixed-seed probes were deterministic.
